...
extern struct bl602_hal_tmr bl602_pwm2;
#endif
#if MYNEWT_VAL(TIMER_1)
extern struct bl602_hal_tmr bl602_pwm1;
#endif
#if MYNEWT_VAL(TIMER_2)
extern struct bl602_hal_tmr bl602_pwm0;
#endif
...
#ifdef TODO  ////
static void
bl602_periph_create_timers(void)
{
    int rc;
...
#if MYNEWT_VAL(TIMER_0)
    rc = hal_timer_init(0, (void *)&bl602_pwm2);
    assert(rc == 0);
#endif
#if MYNEWT_VAL(TIMER_1)
    rc = hal_timer_init(1, (void *)&bl602_pwm1);
    assert(rc == 0);
#endif
#if MYNEWT_VAL(TIMER_2)
    rc = hal_timer_init(2, (void *)&bl602_pwm0);
    assert(rc == 0);
#endif
...
void
bl602_periph_create(void)
{
#ifdef TODO  ////
    bl602_periph_create_timers();
    bl602_periph_create_uart();
    bl602_periph_create_spi();
#endif  ////  TODO
}
